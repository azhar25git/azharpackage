...
<div class="w-full max-w-xs">
    <form action="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ (empty($book) ? route('azhar-package::books.store') : route('azhar-package::books.update', ['book'=>$book]))}}">
        @csrf
